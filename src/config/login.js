...
// 检测api是否登录白名单
export const LOGIN_WHITE_API_LIST = [api.example];
export const NEED_CHECK_LOGIN_ROUTE = ["/pages/index/index"];
 ...
 * @returns {boolean}
 */
export function checkLoginUrlHandler(url) {
 ...
 * @returns {boolean}
 */
export function checkLoginApiHandler(api) {
