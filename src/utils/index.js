 ...
 * @return {string}
 */
export function getRealType(params) {
 ...
 */
export function getNetworkTypeStatus() {
 ...
 * @returns {*}
 */
export function formatUrl(url, baseUrl = import.meta.env.VITE_APP_BASE_URL) {
 ...
 * @return {boolean}
 */
export function isEmpty(params, deep = false) {
 ...
 * @return {*}
 */
export function clearEmpty(params, deep = false) {
