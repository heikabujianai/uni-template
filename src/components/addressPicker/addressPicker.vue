...
const addressContainerShow = ref(false);
const headerHeight = ref(0);
const footerHeight = ref(0);
const address = ref(uni.getStorageSync("addressText") || "全部区域");
const provinceList = ref(provinceJson);
const provinceCode = ref("");
const cityList = ref(provinceList.value[0].cityList);
const cityCode = ref("");
const areaList = ref(cityList.value[0].areaList);
...
const emit = defineEmits(["update:modelValue", "addressSubmit"]);
